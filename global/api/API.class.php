...
class API
{
     ...
     * to embed any special PHP logic in your forms to ensure the data gets submitted to PCPSForms properly.
     *
     ...
     *         this submission; but it only shows up in the PCPSForms UI if you explicitly tell PCPSForms that the
     ...
     *               editable via this function and makes the submission appear in the PCPSForms UI.
     ...
     *        "send_emails": (boolean). By default, PCPSForms will trigger any emails that have been attached to the
...
<div style="padding: 8px; margin: 8px; background-color: #f2dede; border: 1px solid #ebccd1; border-radius: 4px; color: #a94442; display: inline-block; font-family: arial; font-size: 13px; ">
    <b>PCPSForms API Error:</b> $error_code - <a href="https://docs.cloudservetechcentral.com/api/v2/error_codes/#{$error_code}">{$LANG["phrase_error_learn_more"]}</a>
</div>
END;
    }
}
