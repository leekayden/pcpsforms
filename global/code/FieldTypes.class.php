...
class FieldTypes
{
	 ...
	 * has meaning to the browser - to signify that you want an input field. PCPSForms field types are a totally
	 ...
	 *
	 * For instance, if you create a Date field type within PCPSForms, it's really just a <input type="text" />
