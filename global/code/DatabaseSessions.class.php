...
/**
 * Handles database sessions. By default PCPSForms uses PHP sessions, not database sessions. To enable this
...
/**
 * Overrides the default PHP (file-based) sessions with database sessions, allowing using PCPSForms being hosted
 * on multiple servers.
 */
