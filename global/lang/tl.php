...
$LANG["processing_form_incomplete"] = "Paumanhin, ang form na ito ay hindi lilitaw upang maging ganap na-set up mula sa loob ng PCPSForms. Ang pinaka-malamang na sanhi ng problemang ito ay na tinanggal na ang &quot;form_tools_initialize_form&quot; nakatagong form na larangan, ngunit hindi kumpleto ang lahat ng hakbang ng &quot;Magdagdag ng Form&quot; na proseso. <br><br> Mangyaring mag-log in at repasuhin ang mga form ng pagsasaayos.";
...
$LANG["processing_no_redirect_url"] = "Pagsumite Ang proseso ay tama, ngunit hindi na tinukoy mo ang isang redirect na URL para sa form na ito! I-edit ang iyong form sa PCPSForms UI at idagdag ang redirect na URL.";
...
$LANG["text_add_form_step_3_text_1"] = "Narito kung saan masaya ang mga pagsisimula! Sa puntong ito, ang PCPSForms ay naghihintay para sa pagsusumite ng isang pagsubok mula sa iyong form. Ito ay gamitin ang form pagsumite na ito upang malaman kung anong impormasyon ang dapat na naka-imbak sa database.";
...
$LANG["text_create_admin_account"] = "Ngayon kami ay pagpunta sa gumawa ng account ng tagapangasiwa. Ito ay ginamit para sa pamamahala ng lahat ng aspeto ng PCPSForms, tulad ng pagdadagdag ng mga form at paggawa ng account ng kliyente.";
...
$LANG["text_default_file_settings_page"] = "Ang pahinang ito ay naglalarawan sa mga file na i-upload ang mga setting para sa iyong pag-install PCPSForms. Ang mga patakaran ng mag-apply sa lahat ng mga file na nai-upload sa pamamagitan ng PCPSForms, maliban kung malinaw na binigay nang importansiya para sa isang indibidwal na larangan form. Tandaan: kung baguhin mo ang pag-upload ng folder pagkatapos ng mga file na na-upload na, sila ay awtomatikong inilipat na sa bagong folder.";
...
$LANG["text_edit_admin_menu_page"] = "Maaari mong i-edit ang iyong mga menu sa ibaba. Upang masiguro na palagi mong magkaroon ng access sa lahat ng mga pag-andar na magagamit sa loob ng PCPSForms, ang mga sumusunod na mga pahina ay kailangan: Forms, Kliyente, ang iyong Account, Modules, setting at Logout.";
...
$LANG["text_install_create_config_file"] = "PCPSForms mga tindahan ng iyong server at database ng mga setting sa isang file na tinatawag na <b>config.php,</b> natagpuan sa iyong / global / folder. I-click ang &quot;Lumikha ng File&quot; na pindutan upang awtomatikong mabuo ang file sa iyong server.";
$LANG["text_install_create_database_tables"] = "Ngayon kami ay pagpunta sa gumawa ng PCPSForms mga talahanayan ng database. Ang hakbang na ito ay nangangailangan ng database ng kanyang sarili upang magkaroon na nalikha. Kung hindi ka sigurado kung paano gawin ito, mangyaring makipag-ugnayan sa iyong hosting provider.";
...
$LANG["text_install_form_tools_server_not_supported"] = "Paumanhin, ang PCPSForms ay hindi mapapatakbo sa iyong server <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">. Paki-click</a> dito para sa minimum na mga kinakailangan .";
...
$LANG["text_internal_form_desc"] = "Panloob na mga form umiiral lamang sa loob ng Tools Form - hindi sa ibang lugar sa iyong site. Lamang PCPSForms account ng gumagamit ay may access sa form. Piliin ang pagpipiliang ito kung wala kang isang umiiral na form.";
...
$LANG["text_no_themes"] = "Wala kang anumang mga tema tinukoy. I-click ang pindutan sa ibaba upang i-refresh ang listahan ng iyong tema <a href=\"https://docs.cloudservetechcentral.com/userdoc/themes/\">, o suriin ang</a> PCPSForms user papeles para sa impormasyon tungkol sa pagdaragdag ng mga tema.";
...
$LANG["validation_no_default_language"] = "Mangyaring piliin ang default na wika para sa iyong pag-install ng PCPSForms.";
