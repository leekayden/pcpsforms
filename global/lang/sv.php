...
$LANG["notify_no_test_submission"] = "PCPSForms har ännu inte tagit emot något lyckat testinskick.";
...
$LANG["phrase_ft_installation"] = "PCPSForms installationsscript";
...
$LANG["phrase_new_ft_installation"] = "Ny installation av PCPSForms";
...
$LANG["processing_form_incomplete"] = "Tyvärr så verkar inte detta formulär vara helt och hållet inställt inifrån PCPSForms. Troligtvis beror detta på att du tagit bort det gömda formulärfältet \"form_tools_initialize_form\" från webbsidans formulärkod, men utan att fullfölja alla stegen i processen \"Lägg till formulär\". <br /><br />Logga in igen och granska formulärets konfiguration.";
$LANG["processing_init_complete"] = "Tack! Ditt testinskick har passerat igenom systemet som det ska. Gå nu tillbaka till PCPSForms administrationspanel och klicka på knappen \"Ladda om\" på sidan Lägg till formulär, steg 3, för att färdigställa inställningen av ditt formulär.";
...
$LANG["processing_no_form_url_for_recaptcha"] = "PCPSForms kan inte bestämma vart den ska omdirigera när ett misslyckat försök att ange CAPTCHA sker. Du behöver lägga till ett gömt (hidden) fält med namnet <strong>form_tools_form_url</strong> som innehåller URL till formuläret.";
...
$LANG["processing_no_redirect_url"] = "Inskicket processades som det skulle men du har inte angett ett omdirigerings-URL för formuläret! Ändra ditt formulär i PCPSForms gränssnitt och lägg till en omdirigeringsadress.";
...
$LANG["text_add_form_choose_integration_method"] = "Välj vilken metod du vill använda för att integrera ditt formulär med PCPSForms.";
$LANG["text_add_form_code_submission_benefits"] = "Denna metod använder <a href=\"http://docs.cloudservetechcentral.com/api/\" target=\"_blank\">PCPSForms API</a> , som ingår i PCPSForms huvudscript. APIn ger tillgång till ett antal användbara funktioner som gör jobbet med att integrera ditt formulär med PCPSForms så enkelt som möjligt. Det finns inga begränsningar för hur formuläret kan skickas in när du använder API:et. Du kan skicka in innehållet på en gång, eller sida för sida, du kan lägga till dina egna server-side valideringar, CAPTCHA-bilder, du kan välja att skicka in information nu, men bara visa den i PCPSForms användargränssnitt vid en senare tidpunkt (se avsnittet<a href=\"http://docs.cloudservetechcentral.com/api/?page=finalized_submissions\">Finalized Submissions</a> i API-hjälpdokumentation).";
$LANG["text_add_form_code_submission_drawbacks"] = "För att skicka in din formulärdata via PHP, måste formuläret finnas på samma webbplats som denna PCPSForms installation. För icke-tekniska och oerfarna PCPSForms-användare, kan denna metod vara lite skrämmande i början. Men det finns gott om dokumentation för att hjälpa dig, inklusive två enkla steg-för-steg-beskrivningar för att integrera dina en-och flersidiga formulär (dessa kopplas på i ett senare skede).";
$LANG["text_add_form_direct_submission_benefits"] = "Det här är det enklaste sättet att skicka in dina formulärdata till PCPSForms. Det kräver ingen förkunskap om PHP och innebär bara en väldigt liten förändring i din formulärkod. Det passar utmärkt för mindre formulär där du bara vill att besökaren ska skicka in sina data till databasen och därefter slussas vidare till en tacksida.";
$LANG["text_add_form_direct_submission_drawbacks"] = "Denna inskickningsmetod är väldigt enkel att använda men ger inte mycket kontroll för mer komplicerade formulär. Formulär som sträcker sig över flera sidor eller som kräver serverbaserad validering passar bättre med den andra metoden: att skicka formulären via PCPSForms API.";
...
$LANG["text_add_form_step_1_text_1"] = "De följande sidorna guidar dig genom de olika stegen som krävs för att ställa in PCPSForms så att det lagrar dina formulärinskick på rätt sätt. Innan du börjar, försäkra dig om att:";
...
$LANG["text_add_form_step_3_text_1"] = "Det är nu det roliga börjar! Just nu väntar PCPSForms på ett testinskick från ditt formulär. Det kommer att använda detta formulärinskick för att lära sig vilken information som ska lagras i databasen.";
$LANG["text_add_form_step_3_text_2"] = "genom att peka ditt formulär till PCPSForms";
$LANG["text_add_form_step_3_text_3"] = "använda dig av PCPSForms API";
...
$LANG["text_add_form_step_3_text_6"] = "Detta försäkrar att data verkligen skickas vidare till PCPSForms. När du har skickat igenom ditt testinskick så klickar du på knappen nedan.";
...
$LANG["text_add_form_step_5_para_2"] = "Gå därefter till din \"tacksida\" för att tömma sessionen. När detta väl är gjort så kommer alla nya formulärinskick att processas och lagras av PCPSForms. Testa ett par inskick för att försäkra dig om att allt fungerar som det ska.";
...
$LANG["text_config_file_not_created_instructions"] = "Kopiera och klistra in innehållet från nedanstående text i en ny fil som du döper till config.php. Ladda sedan upp den via FTP till din installation av PCPSForms, katalogen /global (den katalogen innehåller också några andra filer och underkataloger samt library.php).";
$LANG["text_confirm_delete_form"] = "Ja, jag vill ta bort detta formulär";
$LANG["text_create_admin_account"] = "Nu ska vi skapa administratörskontot. Det används för att hantera ALLA aspekter av PCPSForms som t ex att lägga till formulär och skapa klientkonton.";
...
$LANG["text_default_file_settings_page"] = "Den här sidan definierar inställningarna för filuppladdning i din PCPSForms installation. Dessa regler gäller för alla filer som laddas upp genom PCPSForms om du inte explicit har undantagit ett speciellt formulärfält någonstans. Observera att om du ändrar uppladdningskatalog efter det att filer har börjat laddas upp så kommer de filerna automatiskt att flyttas till den nya katalogen.";
...
$LANG["text_edit_admin_menu_page"] = "Du kan ändra din meny här nedan. För att försäkra dig om att du alltid har åtkomst till tillgänglig funktionalitet inom PCPSForms så behövs följande sidori din meny: Formulär, Klienter, Ditt konto, Moduler, Inställningar och Logga ut.";
...
$LANG["text_external_form_desc"] = "Externa formulär är formulär som redan finns på din webbplats, eller någon annanstans på webben. Välj detta alternativ om du har ett eget formulär som du vill integrera med PCPSForms.";
...
$LANG["text_form_tools_login_url"] = "URL för inloggning till PCPSForms";
...
$LANG["text_ft_installed"] = "Gratulerar! PCPSForms har nu installerats.";
...
$LANG["text_install_create_config_file"] = "PCPSForms lagrar dina server- och databasinställningar i en fil kallad <strong>config.php</strong> som du hittar i katalogen /global/. Klicka på knappen \"Skapa fil\" för att automatiskt skapa denna fil på din server.";
$LANG["text_install_create_database_tables"] = "Nu ska vi skapa PCPSForms databastabeller. Detta steg kräver att databasen i sig redan är skapad. Om du inte är säker på hur du ska göra detta, kontakta din webbplatsleverantör.";
...
$LANG["text_install_form_tools_server_not_supported"] = "Tyvärr så kommer inte PCPSForms att kunna köras på din server. <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Läs om minimikraven här</a>.";
$LANG["text_install_system_check"] = "Den här sidan kör några tester av ditt system för att försäkra att det kan använda sig av PCPSForms.";
...
$LANG["text_internal_form_desc"] = "Interna formulär existerar endast inom PCPSForms - inte någon annanstans på din webbplats. Endast PCPSForms användarkonton kommer att ha tillgång till formuläret. Välj detta alternativ om du inte har ett befintligt formulär.";
...
$LANG["text_js_required"] = "För att du ska kunna logga in och använda PCPSForms måste du ha aktiverat tillåtelse att köra Javascript i din webbläsare. Aktivera det nu och ladda sedan om denna sidan.";
...
$LANG["text_log_in_to_ft"] = "Logga in till PCPSForms";
...
$LANG["text_no_themes"] = "Du har inga definierade teman. Klicka på knappen nedan för att uppdatera din temalista eller läs mer i <a href=\"https://docs.cloudservetechcentral.com/userdoc/themes/\">PCPSForms användardokumentation</a> kring hur du gör för att lägga till teman.";
...
$LANG["validation_no_default_language"] = "Välj förvalt språk för din installation av PCPSForms.";
...
$LANG["validation_upload_folder_not_writable"] = "Denna tillfälliga uppladdningskatalog som specificerats av din PHP-installation är inte skrivbar. Tills dess att detta problem fixats så kan inte filer laddas upp via PCPSForms (eller något annat PHP-program heller för den delen). Kontakta din webbplatsvärd.";
