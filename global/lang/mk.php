...
$LANG["processing_form_incomplete"] = "За жал, овој образец не се појавува целосно да се воспостави во рок од PCPSForms. Најверојатно причина за овој проблем е во тоа што сте отстранети од &quot;form_tools_initialize_form&quot; скриена форма поле, но не комплетно сите чекори на &quot;Додади Образец&quot; процес. <br><br> Ве молиме да се логирате и преглед форма конфигурација.";
...
$LANG["text_add_form_direct_submission_benefits"] = "Ова е наједноставен начин да ја поднесете вашата форма за да PCPSForms. Тоа не бара никакви познавање на PHP и бара само една мала промена на вашата форма. Таа е одлична за помали форми каде сакате само да ги достави информации за базата на податоци потоа се пренасочи на корисникот на &quot;thankyou&quot; страница.";
...
$LANG["text_add_form_step_3_text_6"] = "Ова обезбедува податоците е всушност праќаат до PCPSForms. Кога ќе се постави во текот на пробната поднесување, кликнете на копчето подолу.";
...
$LANG["text_add_form_step_5_para_2"] = "Потоа посета на својата &quot;благодарам&quot; за да го испразните сесии. Откако ова е направено, сите поднесоци нова форма ќе бидат обработени и зачувани од страна PCPSForms. Обидете се да направите поднесување или две за да ја потврди оваа информација се сите Неуспешно правилно.";
...
$LANG["text_default_file_settings_page"] = "Оваа страница ја дефинира Подигни датотека за вашата конфигурација Образец Алатник инсталација. Овие правила важат за сите датотеки качен преку PCPSForms, освен ако експлицитно overridden за одделен вид терен. Забелешка: Ако промена на фолдерот испратите по датотеки се подигнати, тие ќе бидат автоматски преместена во новата папка.";
...
$LANG["text_form_tools_login_url"] = "Влезот на URL-то за PCPSForms.";
...
$LANG["text_ft_installed"] = "Честитки, PCPSForms е успешно инсталиран!";
...
$LANG["text_install_system_check"] = "Оваа страница трае неколку тестови на вашиот систем, да се осигура дека може да ги стартувате PCPSForms.";
