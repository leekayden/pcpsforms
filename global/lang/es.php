...
$LANG["notify_no_test_submission"] = "PCPSForms no ha recibido ningún envío de prueba con éxito todavía.";
...
$LANG["phrase_ft_installation"] = "Rutina de instalación de PCPSForms";
...
$LANG["processing_form_incomplete"] = "Lo sentimos, esta formulario parece no haber sido configurado correctamente desde PCPSForms. La causa más probable es que hayas eliminado el campo oculto \"form_tools_initialize_form\" de tu formulario, sin haber completado todos los pasos del proceso de \"Agregar formulario\". <br><br> Por favor inicia sesión y revisa la configuración del formulario.";
$LANG["processing_init_complete"] = "Gracias! tu envío de prueba ha sido recibido con éxito. Por favor regresa al panel de administración de PCPSForms y haz clic en el botón de \"Actualizar\", al final del la página del paso 3 del proceso de \"registrar formulario\", para finalizar la configuración de tu formulario.";
...
$LANG["processing_no_form_url_for_recaptcha"] = "PCPSForms es incapaz de determinar a dónde dirigir los usuarios cuando no escriban el CAPTCHA correctamente. Por favor especifica la dirección URL del formulario en un campo oculto de nombre <b>form_tools_form_url</b>.";
...
$LANG["processing_no_redirect_url"] = "El envío fue procesado correctamente, pero no has especificado un URL de salida para este formulario. Puedes establecer un URL de salida para tu formulario desde la Interfaz de Usuario de PCPSForms.";
...
$LANG["text_add_form_step_1_text_1"] = "Las siguientes páginas lo guiarán por los pasos necesarios para configurar PCPSForms para que guarde los registros de su formulario. Antes de continuar, por favor verifique que:";
...
$LANG["text_config_file_not_created_instructions"] = "Copia y pega el contenido de la sección a continuación en un archivo de nombre config.php y cárgalo vía FTP a la carpeta <b>/global</b> del directorio de PCPSForms. (Una carpeta que contiene otros directorios y algunos archivos, entre esos uno llamado library.php).";
$LANG["text_confirm_delete_form"] = "Sí, quiero eliminar esta forma";
$LANG["text_create_admin_account"] = "Ahora vamos a crear la cuenta del administrador. Se usa para gestionar todos los aspectos administrativos de PCPSForms, tales como agregar formularios y la crear cuentas de clientes.";
...
$LANG["text_default_file_settings_page"] = "Esta página define la configuración de la carga de archivos para tu instalación de PCPSForms. Estas normas se aplican a todos los archivos subidos través de PCPSForms, a menos que aquellas sean sustituidas explícitamente para un campo de formulario de manera individual. Nota: si cambias la carpeta de carga después de haber subido archivos, estos se moverán automáticamente a la nueva carpeta.";
...
$LANG["text_edit_admin_menu_page"] = "Puedes editar tu menú a continuación. Para de que siempre tengas acceso a todas las funcionalidades disponibles de PCPSForms, son requeridas las siguientes páginas: Formularios, Clientes, Tu cuenta, Módulos, Configuración y Salir.";
...
$LANG["text_form_tools_login_url"] = "El URL de la página de ingreso de PCPSForms.";
...
$LANG["text_js_required"] = "Para poder iniciar sesión y usar PCPSForms debes habilitar Javascript en tu explorador. Por favor habilítalo y actualiza la página.";
...
$LANG["validation_no_default_language"] = "Favor de ingresar el idioma por defecto para la instalación de PCPSForms.";
...
$LANG["validation_upload_folder_not_writable"] = "Esta carpeta temporal para recibir archivos, especificada por la instalación PHP del servidor, no permite la escritura. Si esto persiste, PCPSForms (o cualquier otro programa) no podrá subir archivos allí. Por favor contacta tu proveedor de hospedaje o modifica los permisos de dicha carpeta.";
