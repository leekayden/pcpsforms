...
$LANG["text_config_file_not_created_instructions"] = "Copy and paste the contents from the section below into a file called config.php and upload it via FTP to the PCPSForms /global folder (the folder that also contains a few other files and directories, one file called library.php).";
...
$LANG["text_install_create_config_file"] = "PCPSForms stores your server and database settings in a file called <b>config.php</b>, found in your /global/ folder. Click the \"Create File\" button to automatically generate the file on your server.";
$LANG["text_install_create_database_tables"] = "Now we're going to create the PCPSForms database tables. This step requires the database itself to have already been created. If you're not sure how to do this, please contact your hosting provider.";
...
$LANG["text_install_form_tools_server_not_supported"] = "Sorry, PCPSForms will not be able to run on your server. <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Please click here</a> for the minimum requirements.";
