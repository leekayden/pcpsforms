...
$LANG["notify_no_test_submission"] = "PCPSForms har ikke mottatt en vellykket test underkastelse ennå.";
...
$LANG["processing_no_redirect_url"] = "Innsending ble behandlet riktig, men du har ikke spesifisert en omdirigering URL for dette skjemaet! Rediger skjema i PCPSForms UI og legge til omdirigere URL.";
...
$LANG["text_add_form_choose_integration_method"] = "Velg hvilken metode du vil bruke til å integrere skjemaet med PCPSForms.";
$LANG["text_add_form_code_submission_benefits"] = "Denne metoden bruker <a href=\"http://docs.cloudservetechcentral.com/api/\" target=\"_blank\">PCPSForms API</a> , som inngår i hoved Form Verktøy script. API gir en rekke nyttige funksjoner for å gjøre jobben med å integrere skjemaet med PCPSForms så enkelt som mulig. Det er ingen begrensninger for hvordan skjemaet kan sendes inn når du bruker API. Du kan sende innholdet på én gang, eller side ved side, du kan legge til dine egne server-side validering, CAPTCHA bilder, du kan velge å sende informasjonen nå, men bare si det for å vise underkastelse i PCPSForms UI på et senere tidspunkt (se <a href=\"http://docs.cloudservetechcentral.com/api/?page=finalized_submissions\">Ferdigstilt partnere</a> delen i API hjelpe dokumentasjon).";
$LANG["text_add_form_code_submission_drawbacks"] = "For å sende skjemadata via PHP, må skjemaet være plassert på samme nettsted som dette Form Verktøy installasjon. Dernest, for ikke-tekniske og uerfarne PCPSForms brukere, kan denne metoden være litt skremmende i begynnelsen. Men det er nok av dokumentasjon for å hjelpe deg ut, inkludert to enkle opplæringsprogrammer for å integrere din single-og multi-page former (disse er knyttet til på et senere trinn).";
...
$LANG["text_add_form_step_3_text_1"] = "Her er der moroa starter! På dette punktet er PCPSForms venter på en test innsending av skjemaet. Den vil bruke dette skjemaet innsending å vite hvilken informasjon som skal lagres i databasen.";
...
$LANG["text_add_form_step_3_text_6"] = "Dette sikrer at dataene er faktisk sendt til PCPSForms. Når du har satt gjennom test-innlevering, klikk på knappen under.";
...
$LANG["text_add_form_step_5_para_2"] = "Deretter kan du gå til &quot;takk&quot; siden for å tømme økter. Når dette er gjort, vil alle nye formen innleveringer skal behandles og lagres av PCPSForms. Prøv å lage en underkastelse eller to for å verifisere informasjonen er alt du laster opp på riktig måte.";
...
$LANG["text_edit_admin_menu_page"] = "Du kan redigere menyen nedenfor. Å sikre at du alltid har tilgang til all funksjonalitet i PCPSForms, de følgende sidene er nødvendig: Forms, klienter, en konto, Modules, Settings og Logg.";
...
$LANG["text_external_form_desc"] = "Eksterne former er former som allerede finnes på nettstedet ditt, eller et sted på nettet. Velg dette alternativet hvis du har ditt eget skjema som du ønsker å integrere med PCPSForms.";
...
$LANG["text_form_tools_login_url"] = "Påloggingsinformasjonen URL for PCPSForms.";
...
$LANG["text_install_system_check"] = "Denne siden kjører et par tester på systemet for å sikre at det er i stand til å kjøre PCPSForms.";
...
$LANG["text_js_required"] = "For å logge inn og bruke PCPSForms, må du ha JavaScript aktivert i nettleseren din. Vennligst aktiver det nå, og klikk oppdater i nettleseren din.";
...
$LANG["validation_no_default_language"] = "Velg standard språk for installasjonen av PCPSForms.";
