...
$LANG["text_add_form_code_submission_benefits"] = "Ez a módszer a <a href=\"http://docs.cloudservetechcentral.com/api/\" target=\"_blank\">PCPSForms API</a> , amely szerepel a fő PCPSForms script. Az API számos olyan hasznos funkciót, hogy a munka integrálása a formát Form eszközök a lehető legegyszerűbb. Nincsenek korlátozások, hogy milyen a formája lehet benyújtani, ha az API. Elküldheti a tartalmat egy menetben, vagy oldalanként, felveheti a saját egyéni szerver oldali validálás, CAPTCHA képek, választhat, hogy nyújtson be az információkat most, csak mondd meg, hogy megjelenjen a benyújtás a PCPSForms UI egy későbbi időpontban (lásd a <a href=\"http://docs.cloudservetechcentral.com/api/?page=finalized_submissions\">véglegesített Beadványok</a> részt a API segítségével dokumentációt).";
...
$LANG["text_add_form_step_3_text_1"] = "Itt, ahol a szórakozás kezdődik! Ezen a ponton, PCPSForms vár egy teszt beadvány az űrlapot. Ez használja ezt az űrlapot benyújtott tudni, milyen információkat kell tárolni az adatbázisban.";
...
$LANG["text_form_tools_login_url"] = "A bejelentkezési URL-PCPSForms.";
...
$LANG["text_install_create_database_tables"] = "Most fogunk létrehozni a PCPSForms adatbázis táblák. Ez a lépés maga az adatbázis, hogy már létrejött. Ha nem biztos abban, hogyan kell ezt csinálni, vegye fel a kapcsolatot a tárhely szolgáltató.";
...
$LANG["text_internal_form_desc"] = "A belső formák léteznek kizárólag PCPSForms - máshol nem a webhelyen. Csak Form eszközök felhasználói fiókok férhetnek hozzá az űrlapot. Válassza ezt az opciót, ha nincs egy meglévő űrlapot.";
...
$LANG["validation_upload_folder_not_writable"] = "Ez az ideiglenes feltölt megadott mappába a PHP nem írható. Amíg ez nem rögzített, fájlokat nem lehet feltölteni keresztül PCPSForms (vagy bármilyen más PHP program). Kérjük, forduljon a tárhely szolgáltató.";
