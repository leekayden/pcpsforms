...
$LANG["phrase_ft_installation"] = "Script di installazione di PCPSForms";
...
$LANG["phrase_new_ft_installation"] = "Nuova installazione di PCPSForms";
...
$LANG["processing_form_incomplete"] = "Spiacenti, ma questo modulo non sembra essere stato pienamente configurato da PCPSForms. La causa più probabile del problema è che avete cancellato il campo nascosto \"form_tools_initialize_form\", ma non avete completato tutti i passi del procedimento di \"Aggiunta modulo\".<br><br>Connettetevi e ricontrollate la configurazione del modulo.";
$LANG["processing_init_complete"] = "Grazie! Il vostro invio di prova è stato ricevuto correttamente. Ritornate al pannello di amministrazione di PCPSForms e cliccate il pulsante \"Ricarica\" nella parte inferiore della pagina \"Aggiunta modulo - Passo 3\" per completare la configurazione del modulo.";
...
$LANG["processing_no_redirect_url"] = "L'invio è stato elaborato correttamente, ma non avete specificato un URL di reindirizzamento di questo modulo! Modificate il modulo nell'IU di PCPSForms, aggiungendo l'URL di reindirizzamento.";
...
$LANG["text_add_form_step_1_text_1"] = "Le pagine seguenti vi guideranno attraverso i diversi passi per configurare PCPSForms in modo che registri gli invii effettuati con il vostro modulo. Prima di continuare, sinceratevi che: ";
...
$LANG["text_form_tools_login_url"] = "L'URL per la connessione a PCPSForms.";
...
$LANG["text_js_required"] = "Per connettersi ed usare PCPSForms, dovete attivare javascript sul vostro browser. Fatelo ora e cliccate dal browser il pulsante di aggiornamento della pagina.";
...
$LANG["validation_no_default_language"] = "Vi preghiamo di selezionare la lingua di base per l'installazione di PCPSForms.";
...
$LANG["validation_upload_folder_not_writable"] = "La cartella di caricamento temporaneo specificata nell'installazione PHP non è scrivibile. Fino a quando ciò non sarà risolto, non si potrà caricare file attraverso PCPSForms (o qualunque altro programma PHP). Vi preghiamo di contattare il vostro fornitore di hosting.";
