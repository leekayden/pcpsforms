...
$LANG["notify_no_test_submission"] = "PCPSForms har ikke modtaget en vellykket test indsendelse endnu.";
...
$LANG["phrase_new_ft_installation"] = "Ny PCPSForms Installation";
...
$LANG["processing_no_form_url_for_recaptcha"] = "PCPSForms er i stand til at afgøre, hvor omdirigere, når de undlader at indtaste CAPTCHA korrekt. Please passere i et skjult felt med navnet <b>form_tools_form_url</b> indeholder URL&#39;en i skemaet.";
...
$LANG["text_add_form_choose_integration_method"] = "Vælg hvilken metode du vil bruge til at integrere din formular med PCPSForms.";
...
$LANG["text_add_form_code_submission_drawbacks"] = "For at indsende din formular data via PHP, skal din form være placeret på samme hjemmeside som denne Formværktøj installation. For det andet, for ikke-tekniske og uerfarne PCPSForms brugere, kan denne metode være lidt skræmmende i starten. Men der er masser af dokumentation til at hjælpe dig ud, herunder to simple tutorials til at integrere din single-og multi-side er (disse er knyttet til på et senere trin).";
$LANG["text_add_form_direct_submission_benefits"] = "Dette er den enkleste måde at indsende din form til PCPSForms. Det kræver ikke noget kendskab til PHP og kræver kun en meget lille ændring i din form. It&#39;s great for mindre former, hvor du bare ønsker at indsende oplysningerne til databasen så omdirigerer brugeren til en &quot;tak&quot; side.";
...
$LANG["text_add_form_step_3_text_2"] = "ved at pege din form til PCPSForms";
...
$LANG["text_config_file_not_created_instructions"] = "Kopier og indsæt indholdet fra afsnittet nedenfor i en fil kaldet config.php og upload det via FTP til den PCPSForms / globale mappe (den mappe, der også indeholder et par andre filer og mapper, en fil kaldet library.php).";
...
$LANG["text_edit_admin_menu_page"] = "Du kan redigere din menuen nedenfor. At sikre, at du altid har adgang til alle funktioner tilgængelige inden PCPSForms, de følgende sider er påkrævet: Forms, Kunder, din konto, Moduler, Indstillinger og Log af.";
...
$LANG["text_form_tools_login_url"] = "Login URL til PCPSForms.";
...
$LANG["text_ft_installed"] = "Tillykke, har PCPSForms blevet installeret!";
...
$LANG["text_install_system_check"] = "Denne side kører et par test på dit system for at sikre, at det er i stand til at køre PCPSForms.";
...
$LANG["text_js_required"] = "For at logge ind og bruge PCPSForms, skal du have javascript aktiveret i din browser. Aktiver venligst nu, og tryk opdater i din browser.";
...
$LANG["validation_no_default_language"] = "Vælg venligst standard sprog for din installation af PCPSForms.";
...
$LANG["validation_upload_folder_not_writable"] = "Der er ikke adgang til at skrive i den midlertidige upload mappe du har specificeret i din PHP installation. Indtil dette er rettet, kan filer ikke uploades via PCPSForms (eller andre PHP programmer). Kontakt venligst din webhost.";
