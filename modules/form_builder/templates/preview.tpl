...
{else}
  ...
  <div class="paged_dialogs" id="help_dialog" style="display:none">
    ...
    <div class="row2_page dialog_page" style="display:none">
      ...
      <p>
        A PCPSForms form can have any number of <i>Views</i>. The View controls various aspects of your published
        form, for example:
      </p>
      ...
      <ol>
        ...
        <li>Whether the fields are arranged into tabs when editing the data in the PCPSForms interface.</li>
      </ol>
