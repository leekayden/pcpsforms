...
$L["module_description"] = "Publish any PCPSForms form to make it publicly available on your website.";
...
$L["text_template_set_intro"] = "The Form Builder module provides a new \"Publish\" tab when editing your form, which you can use to publish the forms you configure within PCPSForms onto your own site. The table below lists all available Template Sets, which are used to control the appearance of your published forms.";
...
$L["text_form_builder_add_form_section"] = "This creates a new form that's been configured with the Form Builder. Form Builder forms are forms that are created and managed within the PCPSForms interface, but published on your own website. (RECOMMENDED FOR MOST USERS)";
...
$L["text_add_form_access_hint"] = "This setting controls which PCPSForms users get access to the data.";
